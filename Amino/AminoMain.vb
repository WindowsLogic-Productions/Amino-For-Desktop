...
#Region "Buttons"
    ...
    Private Sub JoinButton_Click(sender As Object, e As EventArgs) Handles JoinButton.Click
        GeckoWebBrowser1.Navigate("https://aminoapps.com/c/suburbansuite")
    End Sub
    ...
    Private Sub GeckoWebBrowser1_Navigated(sender As Object, e As GeckoNavigatedEventArgs) Handles GeckoWebBrowser1.Navigated
        If GeckoWebBrowser1.Url.ToString = "https://aminoapps.com/c/anime/home/" Then
            MsgBox("Anime Amino Leaders and Curators abuse their powers and could ban you at any point for no reason. As a precaution, we have blocked it.", MsgBoxStyle.Exclamation)
            GeckoWebBrowser1.GoBack()
        End If
    End Sub
