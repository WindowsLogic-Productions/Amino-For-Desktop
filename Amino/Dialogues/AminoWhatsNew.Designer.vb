...
Partial Class AminoWhatsNew
    ...
    Private Sub InitializeComponent()
        ...
        Me.ListBox1.Items.AddRange(New Object() {"~Version 1.0.1.1~", "1. Fixed a bug where the 'Suburban Suite' button wouldn't work.", "2. Added keyboard shortcut, Alt+S to quickly access the 'Settings Panel'.", "3. Anime Amino is now blocked as a precaution to stop you getting wrongfully bann" &
