...
Partial Class AminoWhatsNew
    ...
    Private Sub InitializeComponent()
        ...
        Me.ListBox1.Items.AddRange(New Object() {"~Version 2.0.0.1~", "1. Fixed a bug where the 'About' dialogue would show in the taskbar.", "2. Fixed a bug where the 'Automatic Updates' dialogue would show in the taskbar.", "3. Changed updater code to point to new update servers.", "4. Fixed some user interface elements not using the Windows animations.", "5. Fixed a bug where enabling/disabling updates didn't work.", "", "~Version 2.0.0.0~", "1. Added 'Jump To...' which allows users to jump to Aminos via ID.", "2. Added 'Topic Search' which allows users to search for Amino communities or top" &
