...
Partial Class AminoWhatsNew
    ...
    Private Sub InitializeComponent()
        ...
        Me.ListBox1.Items.AddRange(New Object() {"~Version 2.0.0.0~", "1. Added 'Jump To...' which allows users to jump to Aminos via ID.", "2. Added 'Topic Search' which allows users to search for Amino communities or top" &
